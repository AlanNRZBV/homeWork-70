...
export const fetchContactForEdit = createAsyncThunk<void, string,{state: RootState}>(
...
export const editContact = createAsyncThunk<void, IContactData,{state: RootState}>(
