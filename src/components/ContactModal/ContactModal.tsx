...
const ContactModal = () => {
  ...
  const isModalLoading = useSelector((state: RootState)=>state.contactModal.isLoading)
  const isModalDeleting = useSelector((state: RootState)=>state.contactModal.isDeleting)
  const contactInfo = useSelector((state: RootState)=> state.contactModal.contactInfo)
        ...
        {isModalLoading ? (
          ...
          <>
            ...
            <div className="d-flex justify-content-center">
              <button type="button" className="btn btn-secondary me-3" disabled={isModalDeleting}>
                Edit
              </button>
              <button onClick={deleteOnClickHandler} type="button" className="btn btn-outline-danger">
